      ...
      <div className="space-y-4">
        <div className="flex justify-center mb-6">
          <div className="relative">
            <img 
              src={formData.avatarUrl || '/api/placeholder/150/150'} 
              alt="Profile"
        ...
        <div className="flex gap-4 pt-4">
          <button
            onClick={handleSave}
            className={`
              flex-1 bg-blue-500 text-white py-3 rounded-lg font-medium hover:bg-blue-600
          ...
          <button
            onClick={onClose}
            className={`
              flex-1 py-3 rounded-lg font-medium border
              ${isDark ? 'border-gray-600 hover:bg-gray-700' : 'border-gray-300 hover:bg-gray-50'}
            `}
          >
            Cancel
