...
const LeftPopup: React.FC<PopupProps> = ({ config, isDark = false, onClose, data }) => {
  const [historyItems, setDirectoryItems] = useState<any[]>([]);
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-semibold">Activity Directory</h2>
          <button
            onClick={onClose}
